...
NOTE: vega was changed to be a decimal after the calculations were done, 
      so the "/100" was added to not change computed values.
'''
import pytest
from src.pricer import calculate_greeks
